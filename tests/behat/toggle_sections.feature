...
Feature: Sections can be expanded in collapsibleweeks format
  In order to view/hide weeks content in courses
  As a user
  I can expand/collapse weeks
  ...
  Scenario: Expand/collapse section 1 with clicks on toggle icon when editing mode is off
    When I click on "1 May - 7 May" "link" in the "li#section-1" "css_element"
    ...
    And I click on "1 May - 7 May" "link" in the "li#section-1" "css_element"
