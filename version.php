...
$plugin->version   = 2019082800;        // The current plugin version (Date: YYYYMMDDXX).
$plugin->maturity = MATURITY_STABLE;
$plugin->requires  = 2019052000;        // Requires this Moodle version.
$plugin->component = 'format_collapsibleweeks';    // Full name of the plugin (used for diagnostics).
$plugin->release = '3.7.1'; // Align version number with most recent moodle compatible version.
