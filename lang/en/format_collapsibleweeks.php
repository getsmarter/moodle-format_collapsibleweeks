...
$string['privacy:metadata:preference:sectionstoggle'] = 'Toggle state for weeks of a course.';
$string['privacy:request:preference:sectionstoggle'] = 'You kept weeks {$a->value}" opened in course {$a->name}';
